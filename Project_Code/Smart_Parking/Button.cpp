...
Button::Button(size_t x_location, size_t y_location, size_t width, size_t height, size_t colorFill, size_t fontColor, char* button_message) { _x_location = x_location; _y_location = y_location;
_width = width; _height = height, _colorFill = colorFill; _fontColor = fontColor; _message = button_message;}
